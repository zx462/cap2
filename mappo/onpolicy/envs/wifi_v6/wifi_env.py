"""WiFi v6 environment with scenario-based active MLD/SLD counts."""
...
class WiFiEnvV6:
    ...
    - max_mld * 2 agents are kept fixed; scenario controls active MLD/SLD counts
    """
    ...
    def __init__(
        ...
        self.share_obs_dim = self.obs_dim * self.max_mld + 2 + self.max_mld + 2 + 2
