#!/usr/bin/env python
"""Evaluate a BEB baseline on WiFi v7.1 with fixed-duration Mbps metrics."""
...
def parse_args(args, parser):
    ...
    parser.add_argument("--wandb_project", type=str, default="WiFi_v7_1_beb_eval_mbps")
    parser.add_argument("--wandb_group", type=str, default="compare_wifi_v7_1_beb_mbps")
...
def main(args):
    ...
    run_dir = build_eval_run_dir(all_args, "wifi_v7_1_beb_mbps")
    run = init_wandb(all_args, run_dir, "wifi_v7_1_beb_mbps")
    ...
    for episode in range(all_args.eval_episodes):
        ...
        print(
            f"[BEB Mbps Eval] Episode {episode + 1}/{all_args.eval_episodes} | "
    ...
    save_summary(run_dir, "beb_mbps_summary.json", summary)
