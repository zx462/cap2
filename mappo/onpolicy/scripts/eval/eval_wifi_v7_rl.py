#!/usr/bin/env python
"""Evaluate a trained WiFi v7 RL policy checkpoint on one active scenario."""
...
from onpolicy.envs.wifi_v7.wifi_env import WiFiEnvV7
...
def compute_v7_episode_metrics(env, infos, episode_reward_total: float):
...
def parse_args(args, parser):
    ...
    parser.add_argument("--wandb_project", type=str, default="WiFi_v7_eval")
    parser.add_argument("--wandb_group", type=str, default="compare_wifi_v7")
...
def main(args):
    ...
    run_dir = build_eval_run_dir(all_args, "wifi_v7_rl")
    run = init_wandb(all_args, run_dir, "wifi_v7_rl")
    ...
    for episode in range(all_args.eval_episodes):
        ...
        metrics = compute_v7_episode_metrics(env, last_infos, episode_reward_total)
