#!/usr/bin/env python
"""Train MAPPO on the WiFi v4 slot-time access-opportunity environment."""
...
def parse_args(args, parser):
    ...
    parser.add_argument(
        ...
        type=str,
        default="wifi_v4",
        help="Weights & Biases project name for WiFi v4 runs",
    )
...
def main(args):
    ...
    setproctitle.setproctitle(
        f"{all_args.algorithm_name}-wifi-v4-{all_args.experiment_name}"
    )
