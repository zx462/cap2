#!/usr/bin/env python
"""Train MAPPO on the WiFi v7 scenario-rotation environment."""
...
def parse_args(args, parser):
    ...
    parser.add_argument(
        ...
        default="sequential",
        choices=["sequential"],
        help="Scenario order. v7 initially supports sequential order only.",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=str,
        default="wifi_v7",
        help="Weights & Biases project name for WiFi v7 runs",
    )
    parser.add_argument(
        "--wandb_entity",
        type=str,
...
def main(args):
    ...
    setproctitle.setproctitle(
        f"{all_args.algorithm_name}-wifi-v7-{all_args.experiment_name}"
    )
